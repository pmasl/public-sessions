...
ADD TARGET package0.event_file(SET filename=N'C:\IP\Tiger\Gems to help you troubleshoot query performance\Demos\Demo 1 - Per-operator level performance stats\QueryProfileXE.xel',max_file_size=(50),max_rollover_files=(2))
...
WHERE plan_handle = 0x0600050006F6081980E2800BDD01000001000000000000000000000000000000000000000000000000000000
GO
-- And to get the plan from cache
SELECT * FROM sys.dm_exec_query_plan(0x0600050006F6081980E2800BDD01000001000000000000000000000000000000000000000000000000000000)
GO
