...
the Product table in the AdventureWorks2016CTP3 database. Additionally, 
...
FROM Production.Product AS p 
INNER JOIN Sales.SalesOrderDetail_inmem AS sod
...
USE AdventureWorks2016CTP3;
GO
SELECT ProductID, SpecialOffer_inmemID, AVG(UnitPrice) AS 'Average Price', 
    SUM(LineTotal) AS SubTotal
FROM Sales.SalesOrderDetail_inmem
GROUP BY ProductID, SpecialOffer_inmemID
ORDER BY ProductID;
GO
