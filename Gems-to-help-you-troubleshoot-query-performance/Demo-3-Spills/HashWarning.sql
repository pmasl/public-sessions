...
ADD TARGET package0.event_file(SET filename=N'C:\IP\Tiger\Gems to help you troubleshoot query performance\Demos\Demo 3 - Spills\HashSpills.xel',max_file_size=(50),max_rollover_files=(2))
